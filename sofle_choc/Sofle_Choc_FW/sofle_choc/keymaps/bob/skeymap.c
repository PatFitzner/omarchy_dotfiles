...
[_QWERTY] = LAYOUT( \
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_MUTE,   KC_MPLY,KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                      KC_LALT, KC_LGUI, KC_LCTRL, KC_LOWER,KC_ENT,    KC_SPC, KC_LOWER, KC_RALT,KC_DEL, KC_RGUI, 
),
/* LOWER
 * ,----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 */
[_LOWER] = LAYOUT(
    KC_GRV, KC_F1,    KC_F2,   KC_F3,   KC_F4,    KC_F5,                         KC_NUM, KC_PSLS,   KC_PAST, KC_PMNS,   KC_BSPC,  KC_PSCR,
    _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,                         KC_P7, KC_P8,  KC_P9,   KC_PPLS,  KC_LBRC, KC_RBRC,
    _______, KC_F11, KC_F12, KC_F13, KC_F14,  KC_F15,                         KC_P4, KC_P5,   KC_P6, KC_PIPE,   KC_LCBR,   KC_RCBR,
    _______, KC_F16, KC_F17, KC_F18, KC_F19,  KC_F20, _______,       _______, KC_P1, KC_P2,  KC_P3, KC_P3,   KC_HOME,  KC_END,
                      KC_F21, KC_F22, KC_F23,  _______, _______,       _______, _______,  KC_P0,   KC_PDOT, _______
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_MUTE,   KC_MPLY,KC_K,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                      KC_LALT, KC_LGUI, KC_LCTRL,KC_LOWER,KC_ENT,    KC_SPC, KC_RAISE, KC_RALT,KC_RGUI , 
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
